...
public class LogoHud extends HudElement {
    ...
    public static final HudElementInfo<LogoHud> INFO = new HudElementInfo<>(Addon.HUD_GROUP, "logohud", "wow", LogoHud::new);
    ...
    private final Identifier TEXTURE = new Identifier("template", "logo.png");
